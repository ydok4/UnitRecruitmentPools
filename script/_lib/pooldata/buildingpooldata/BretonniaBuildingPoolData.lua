BretonniaBuildingPoolData = {
	...
	wh_main_brt_barracks_4 = {
		...
		PreviousBuilding = "wh_main_brt_barracks_3",
	},
	wh_main_brt_stables_1 = {
		Units = {
	...
	wh_main_brt_stables_2 = {
		...
		PreviousBuilding = "wh_main_brt_stables_1",
	},
	wh_main_brt_stables_3 = {
		Units = {
			wh_main_brt_cav_mounted_yeomen_0 = {
				UnitReserveCapChange = "1",
				ImmediateUnitReservesChange = "0",
		...
		PreviousBuilding = "wh_main_brt_stables_2",
	},
	wh_main_brt_stables_4 = {
		Units = {
			wh_main_brt_cav_mounted_yeomen_0 = {
				UnitReserveCapChange = "1",
				ImmediateUnitReservesChange = "0",
		...
		PreviousBuilding = "wh_main_brt_stables_3",
	},
	wh_main_brt_stables_5 = {
		Units = {
		...
		PreviousBuilding = "wh_main_brt_stables_4",
	},
	wh_main_brt_carpenter_1 = {
		Units = {
	...
	wh_main_brt_carpenter_2 = {
		Units = {
			...
			wh_dlc07_brt_art_blessed_field_trebuchet_0 = {
				UnitReserveCapChange = "1",
				ImmediateUnitReservesChange = "25",
				UnitGrowthChange = "10",
			},
		},
		PreviousBuilding = "wh_main_brt_carpenter_1",
	},
	...
	wh_main_brt_worship_3 = {
		...
		PreviousBuilding = "wh_main_brt_worship_2",
	},
	wh_main_brt_farm_1 = {
		Units = {
	...
	wh_main_brt_farm_2 = {
		...
		PreviousBuilding = "wh_main_brt_farm_1",
	},
	wh_main_brt_farm_3 = {
		Units = {
			wh_dlc07_brt_inf_peasant_bowmen_1 = {
		...
		PreviousBuilding = "wh_main_brt_farm_2",
	},
}