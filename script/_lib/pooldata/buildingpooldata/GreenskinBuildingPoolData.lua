GreenskinBuildingPoolData = {
	wh_main_sc_grn_greenskins = {
		...
		wh_main_grn_military_2 = {
			...
			PreviousBuilding = "wh_main_grn_military_1",
		},
		wh_main_grn_military_3 = {
			...
			PreviousBuilding = "wh_main_grn_military_2",
		},
		wh_main_grn_military_4 = {
			...
			PreviousBuilding = "wh_main_grn_military_3",
		},
		wh_main_grn_boars_1 = {
			Units = {
		...
		wh_main_grn_boars_2 = {
			...
			PreviousBuilding = "wh_main_grn_boars_1",
		},
		wh2_main_special_troll_lair_1 = {
			Units = {
		...
		wh_main_grn_workshop_2 = {
			...
			PreviousBuilding = "wh_main_grn_workshop_1",
		},
		...
		wh_main_grn_monsters_2 = {
			...
			PreviousBuilding = "wh_main_grn_monsters_1",
		},
		...
		wh_main_grn_forest_beasts_2 = {
			...
			PreviousBuilding = "wh_main_grn_forest_beasts_1",
		},
		wh_main_grn_forest_beasts_3 = {
			...
			PreviousBuilding = "wh_main_grn_forest_beasts_2",
		},
		wh_main_special_savage_orc_camp_1 = {
			Units = {
		...
		wh_main_special_savage_orc_camp_2 = {
			Units = {
				wh_main_grn_inf_savage_orcs = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
			...
			PreviousBuilding = "wh_main_special_savage_orc_camp_1",
		},
		wh_main_special_savage_orc_camp_3 = {
			Units = {
				wh_main_grn_inf_savage_orcs = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
			...
			PreviousBuilding = "wh_main_special_savage_orc_camp_2",
		},
		wh_dlc06_grn_squigs_1 = {
			Units = {
				wh_dlc06_grn_inf_squig_herd_0 = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
		...
		wh_dlc06_grn_military_1_skarsnik = {
			Units = {
				wh_main_grn_inf_goblin_spearmen = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
		...
		wh_dlc06_grn_military_2_skarsnik = {
			Units = {
				wh_main_grn_inf_goblin_spearmen = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
			...
			PreviousBuilding = "wh_dlc06_grn_military_1_skarsnik",
		},
		wh_dlc06_grn_military_3_skarsnik = {
			Units = {
				wh_main_grn_inf_goblin_spearmen = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
			...
			PreviousBuilding = "wh_dlc06_grn_military_2_skarsnik",
		},
		wh_dlc06_grn_military_4_skarsnik = {
			Units = {
				wh_main_grn_inf_goblin_spearmen = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
			...
			PreviousBuilding = "wh_dlc06_grn_military_3_skarsnik",
		},
		wh_dlc06_grn_boars_1_skarsnik = {
			Units = {
				wh_main_grn_cav_orc_boar_boyz = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
		...
		wh_dlc06_grn_boars_2_skarsnik = {
			...
			PreviousBuilding = "wh_dlc06_grn_boars_1_skarsnik",
		},
		...
		wh_dlc06_grn_eight_peaks_2 = {
			...
			PreviousBuilding = "wh_dlc06_grn_eight_peaks_1",
		},
		wh_dlc06_grn_eight_peaks_3 = {
			...
			PreviousBuilding = "wh_dlc06_grn_eight_peaks_2",
		},
		wh_dlc06_special_savage_orc_camp_wurrzag_1 = {
			Units = {
				wh_main_grn_inf_savage_orcs = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
		...
		wh_dlc06_special_savage_orc_camp_wurrzag_2 = {
			Units = {
				wh_main_grn_inf_savage_orcs = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
			...
			PreviousBuilding = "wh_dlc06_special_savage_orc_camp_wurrzag_1",
		},
		wh_dlc06_special_savage_orc_camp_wurrzag_3 = {
			Units = {
				wh_main_grn_inf_savage_orcs = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
			...
			PreviousBuilding = "wh_dlc06_special_savage_orc_camp_wurrzag_2",
		},
		wh2_main_special_clar_karond_lairs_grn = {
			Units = {
				wh_main_grn_mon_giant = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
