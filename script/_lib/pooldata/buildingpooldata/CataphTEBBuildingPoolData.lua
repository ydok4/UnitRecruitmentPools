CataphTEBBuildingPoolData = {
	-- Default/shared units
	wh_main_sc_teb_teb = {
		...
		wh_main_emp_forges_2 = {
			Units = {
				...
				wh_main_emp_art_great_cannon = false,
				wh_main_emp_art_helstorm_rocket_battery = false,
			},
			PreviousBuilding = "wh_main_emp_forges_1",
		},
		wh_main_emp_forges_3 = false,
	},
	-- Border princes
	wh_main_teb_border_princes = {
		...
		wh_main_emp_barracks_3 = {
			Units = {
				...
				wh_main_emp_inf_greatswords = false,
				wh_dlc04_emp_inf_free_company_militia_0 = false,
				bor_rangers = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "0",
		...
		wh_main_emp_stables_2 = {
			...
			PreviousBuilding = "wh_main_emp_stables_1",
		},
		...
		teb_mercs_2 = {
			Units = {
				...
				wh_main_dwf_inf_dwarf_warrior_1 = {
					...
					ImmediateUnitReservesChange = "50",
					UnitGrowthChange = "25",
					ApplyToUnit = "dwf_warriors2h_teb",
				},
				bor_mercs = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
				...
				wh_dlc06_dwf_inf_rangers_0 = {
					...
					ImmediateUnitReservesChange = "50",
					UnitGrowthChange = "25",
					ApplyToUnit = "dwf_rangers_teb",
				},
				CTT_teb_swordsmen = false,
			},
			PreviousBuilding = "teb_mercs_1",
		},
		teb_mercs_3 = {
			Units = {
				wh_main_dwf_art_cannon = {
					...
					ImmediateUnitReservesChange = "0",
					UnitGrowthChange = "25",
					ApplyToUnit = "dwf_cannon_teb",
				},
				wh_main_dwf_art_organ_gun = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
					UnitGrowthChange = "25",
					ApplyToUnit = "dwf_organ_teb",
				},
				wh_main_dwf_inf_dwarf_warrior_0 = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
			...
			PreviousBuilding = "teb_mercs_2",
		},
		wh_main_teb_worship_1 = {
			Units = {
				wh_dlc04_emp_inf_flagellants_0 = false,
			},
		},
		wh_main_teb_worship_2 = {
			Units = {
				wh_dlc04_emp_inf_flagellants_0 = false,
			},
			PreviousBuilding = "wh_main_teb_worship_1",
		},
	},
	-- Estalia
	wh_main_teb_estalia = {
		...
		wh_main_special_archecclesiatium = {
			Units = {
				est_kotrs = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
	...
	wh_main_teb_tilea = {
		...
		wh_main_teb_port_3 = {
			...
			PreviousBuilding = "wh_main_teb_port_2",
		},
	},
	-- Tobrao (Lucrezzia)
	wh_main_teb_tobaro = {
	...
	wh2_main_emp_new_world_colonies = {
		...
		teb_homeland_2 = {
			Units = {
				...
				til_broken_lances_col = {
					...
					ImmediateUnitReservesChange = "50",
					UnitGrowthChange = "25",
					ApplyToUnit = "til_broken_lances",
				},
				til_pavise_col = {
					UnitReserveCapChange = "1",
					ImmediateUnitReservesChange = "50",
					UnitGrowthChange = "25",
					ApplyToUnit = "til_pavise",
				},
				CTT_teb_swordsmen = false,
			},
		...
		teb_homeland_3 = {
			...
			PreviousBuilding = "teb_homeland_2",
		},
		teb_homeland_1_vtx = {
			Units = {
				est_cav_col = {
		...
		teb_homeland_2_vtx = {
			...
			PreviousBuilding = "teb_homeland_1_vtx",
		},
		teb_homeland_3_vtx = {
			Units = {
				est_cav_col = {
			...
			PreviousBuilding = "teb_homeland_2_vtx",
		},
		wh_main_teb_worship_1 = {
			Units = {
				wh_dlc04_emp_inf_flagellants_0 = false,
