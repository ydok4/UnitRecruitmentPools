EmpireBuildingPoolData = {
	wh_main_sc_emp_empire = {
		...
		wh_main_emp_forges_3 = {
			Units = {
				...
				wh_main_emp_veh_steam_tank_driver = {
					...
					ImmediateUnitReservesChange = "50",
					UnitGrowthChange = "10",
					ApplyToUnit = "wh_main_emp_veh_steam_tank",
				},
			},
			PreviousBuilding = "wh_main_emp_forges_2",
		},
		...
		wh_main_emp_worship_2 = {
			...
			PreviousBuilding = "wh_main_emp_worship_1",
		},
		...
		wh_main_talabec_worship_2 = {
			...
			PreviousBuilding = "wh_main_talabec_worship_1",
		},
